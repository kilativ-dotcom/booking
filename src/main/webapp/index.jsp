...
<form name="toLoginForm" action="${Constants.FRONT_CONTROLLER_SERVLET_VALUE}" method="post">
...
<form name="toSignupForm" action="${Constants.FRONT_CONTROLLER_SERVLET_VALUE}" method="post">
