...
<form name="viewResponsesForm" method="post" action="${Constants.FRONT_CONTROLLER_SERVLET_VALUE}">
    <input type="hidden" name="${Constants.PARAM_COMMAND}" value="viewResponses">
    <input type="submit" value="<fmt:message key="label.viewResponses"/>">
</form>

<form name="viewRequestsForm" method="post" action="${Constants.FRONT_CONTROLLER_SERVLET_VALUE}">
    <input type="hidden" name="${Constants.PARAM_COMMAND}" value="viewRequests">
    <input type="submit" value="<fmt:message key="label.viewRequests"/>">
</form>

<form name="viewUsersForm" method="post" action="${Constants.FRONT_CONTROLLER_SERVLET_VALUE}">
    <input type="hidden" name="${Constants.PARAM_COMMAND}" value="viewUsers">
    <input type="submit" value="<fmt:message key="label.viewUsers"/>">
</form>

<form name="viewSuitesForm" method="post" action="${Constants.FRONT_CONTROLLER_SERVLET_VALUE}">
    <input type="hidden" name="${Constants.PARAM_COMMAND}" value="viewSuites">
    <input type="submit" value="<fmt:message key="label.viewSuites"/>">
</form>

<form name="viewSuiteClassesForm" method="post" action="${Constants.FRONT_CONTROLLER_SERVLET_VALUE}">
    <input type="hidden" name="${Constants.PARAM_COMMAND}" value="viewSuiteClasses">
