...
public class RequestsService {
    ...
    public static Optional<Request> creteRequest(User user, String checkInDate, String checkOutDate, int guests, String comment, SuiteClass suiteClass) {
...
//            requestDao.setConnection(connection);
    ...
    public static List<Request> getRequestsFromUser(int userId){
        try(WrapperConnection connection = ConnectionPoolImpl.getInstance().getConnection()) {
...
//            requestDao.setConnection(connection);
    ...
    public static void cancelRequestById(int requestId){
        try (WrapperConnection connection = ConnectionPoolImpl.getInstance().getConnection()){
            BaseRequestDao requestDao = new RequestDaoImpl(connection);
//            requestDao.setConnection(connection);
...
//            requestDao.setConnection(connection);
    ...
    public static List<Request> getUnansweredRequests(){
        try(WrapperConnection connection = ConnectionPoolImpl.getInstance().getConnection()){
            BaseRequestDao requestDao = new RequestDaoImpl(connection);
//            requestDao.setConnection(connection);
