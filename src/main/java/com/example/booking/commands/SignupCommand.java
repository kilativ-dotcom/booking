...
public class SignupCommand implements Command {
    ...
    public AbstractPage execute(HttpServletRequest request) {
        ...
        Optional<User> optionalUser = SignupService.signupLoginPassword(name, password);
        ...
        if (optionalUser.isPresent()) {
            ...
            request.setAttribute(Constants.SIGNUP_PAGE_MESSAGE, "Unable to create user with this credentials.");
