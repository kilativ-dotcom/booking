...
public class RequestCreationFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws ServletException, IOException {
        ...
        if (checkInDate == null || checkInDate.trim().isEmpty()
            ...
            abort(httpRequest, httpResponse, checkInDate, checkOutDate, comment, guests, suiteClassId, suiteClass, command, message);
            return;
        }
    ...
    private void abort(HttpServletRequest httpRequest, HttpServletResponse httpResponse, String checkInDate, String checkOutDate, String comment, String guests, String suiteClassId, String suiteClass, String command, String messageValue) throws ServletException, IOException {
        bindAttributes(httpRequest, checkInDate, checkOutDate, comment, guests, suiteClassId, suiteClass);
        LOGGER.trace("setting message: " + messageValue);
        httpRequest.setAttribute(Constants.ATTRIBUTE_BOOKING_MESSAGE, messageValue);
