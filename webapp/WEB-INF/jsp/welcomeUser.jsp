...
<body>
<form name="bookSuiteForm" method="post" action="${Constants.FRONT_CONTROLLER_SERVLET_VALUE}">
...
<form name="viewResponsesForm" method="get" action="${pageContext.request.contextPath}/view/responses">
    <input type="submit" value="<fmt:message key="label.viewResponses"/>">
</form>

<form name="viewRequestsForm" method="get" action="${pageContext.request.contextPath}/view/requests">
