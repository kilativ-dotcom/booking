                ...
                <table>
                    ...
                    <c:forEach var="suiteClass" items="${suiteClasses}">
                        <tr>
                            ...
                            <td>
                                <button form="changeSuiteClassForm" name="${Constants.PARAMETER_SUITE_CLASS_TO_CHANGE}" value="${suiteClass.id}"><fmt:message key="button.change"/></button>
                            </td>
                            <td>
                                <button form="deleteSuiteClassForm" name="${Constants.PARAMETER_SUITE_CLASS_TO_DELETE}" value="${suiteClass.id}"><fmt:message key="button.delete"/></button>
                            </td>
                        </tr>
                    </c:forEach>
                </table>
